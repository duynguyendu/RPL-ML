...
\cite{santosMLRPLMachineLearningBased2023} proposed using machine
learning model to train on eight metrics namely RSSI, ETX, ...
to predict the probability if a packet is
transmitted successfully. They used CatBoost model to train (...)
Despite that, they use classification to predict the chance of
sending one packet successfully instead of whole PDR.
