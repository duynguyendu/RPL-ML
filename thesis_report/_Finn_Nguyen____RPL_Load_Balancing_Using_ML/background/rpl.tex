...
parameters to determine the sending window of DIO: $I_{min}$,
$I_{max}$ and $k$ as shown in Table~\ref{tab:tricker_timer_params};
and the maximum sending interval time
$I_{max\_time}$ is calculated as:
\[
...
properties of a certain neighbour, which compute $Rank\_increase$ as
\[
