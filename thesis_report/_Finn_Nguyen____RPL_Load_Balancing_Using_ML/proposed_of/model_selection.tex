...
lightweight and fast, while also robust when using interger instead
...
In the end, we decide to proceed with Random Forest and LGBMTreeRegressor due to the design and
